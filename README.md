...
- Navigate to `funkychat` folder
- Select `funkychat.bot` file
...
msbot clone services --name "funkychat" --code-dir "." --location <azure region like eastus, westus, westus2 etc.> --sdkLanguage "Node" --folder deploymentScripts/msbotClone --verbose
```
